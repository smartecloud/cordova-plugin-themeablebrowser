    ...
    exports.closeBrowser = function (eventname) {
        exec(null, null, 'ThemeableBrowser', 'close', []);
        return this;
    };
    ...
    exports.isPlatformIOS = function () {
        return device.platform == "iPhone" || device.platform == "iPad" || device.platform == "iPod touch" || device.platform == "iOS"
    }


    exports.successNotification = function (data) {
        console.log("exports.successNotification->" + data);

        if (this.isPlatformIOS()) {
            alert("ios");
            var bToObj = JSON.parse(data);
            //    console.log("data->"  + JSON.stringify(data));
            //this.receiveMessage = {"result":data};
        ...
        cordova.fireDocumentEvent('themeableBrowser.successNotification', data);
    }
